...
abstract class UseCase<Param, Source> {
     ...
     */
    abstract suspend fun execute(param: Param) : LiveData<Source>
    ...
    abstract class NoParam<Source> : UseCase<None, Source>() {
         ...
         */
        abstract suspend fun execute() : LiveData<Source>
         ...
         */
        final override suspend fun execute(param: None): LiveData<Source> {
